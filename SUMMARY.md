**Kolektor Surface-Defect Dataset 2** is a dataset for semantic segmentation tasks. It is used in the industrial domain and surface defect detection research. 
